...
public class StatisticsController {
    ...
    public ResponseEntity<DashboardStatisticsResponse> getDashboardStatistics(
        ...
        DashboardStatisticsResponse response = statisticsService.getDashboardStatistics(userDetails.getEmail());
    ...
    public ResponseEntity<EmployeeStatisticsResponse> getEmployeeStatistics(
        ...
        EmployeeStatisticsResponse response = statisticsService.getEmployeeStatistics(userDetails.getEmail(), employeeId, startDate, endDate);
        return ResponseEntity.ok(response);
    }
    ...
    public ResponseEntity<MonthlyStatisticsResponse> getMonthlyStatistics(
        ...
        MonthlyStatisticsResponse response = statisticsService.getMonthlyStatistics(userDetails.getEmail(), year, month);
        return ResponseEntity.ok(response);
    }
    ...
    public ResponseEntity<WeeklyStatisticsResponse> getWeeklyStatistics(
        ...
        WeeklyStatisticsResponse response = statisticsService.getWeeklyStatistics(userDetails.getEmail(), date);
        return ResponseEntity.ok(response);
    }
}
